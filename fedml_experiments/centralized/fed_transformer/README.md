...
ImageNet
```
# all frozen layer + linear classifier
...
# add one layer
nohup sh run_centralized_ddp_frozen_training.sh 8 1 0 127.0.0.1 11111 imagenet /home/chaoyanghe/dataset/cv/imagenet ib0 0.03 0 1 > ./machine1_imagenet.txt 2>&1 &
